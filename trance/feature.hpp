...
#ifndef __TRANCE__FEATURE__HPP__
#define __TRANCE__FEATURE__HPP__ 1
...
{
  inline
  void swap(trance::Feature& x, trance::Feature& y)
  {
    x.swap(y);
  }
};
...
{
  template <>
  struct traits<trance::Feature>
  {
    typedef trance::Feature     value_type;
