...
#ifndef __TRANCE__OPTIMIZE_ADAGRAD__HPP__
#define __TRANCE__OPTIMIZE_ADAGRAD__HPP__ 1
...
namespace trance
{
  namespace optimize
  {
	...
	return eta0_;
      ...
      {
	return eta0 / std::sqrt(std::max(1e-40, epsilon + g));
      }
    ...
    template <>
    inline
    void AdaGrad<model::Model8>::operator()(model::Model8& theta,
