...
#ifndef __RNNP__SYMBOL__HPP__
#define __RNNP__SYMBOL__HPP__ 1
...
{
  inline
  void swap(rnnp::Symbol& x, rnnp::Symbol& y)
  {
    x.swap(y);
  }
};
...
{
  template <>
  struct traits<rnnp::Symbol>
  {
    typedef rnnp::Symbol      value_type;
