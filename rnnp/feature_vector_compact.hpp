...
#ifndef __RNNP__FEATURE_VECTOR_COMPACT__HPP__
#define __RNNP__FEATURE_VECTOR_COMPACT__HPP__ 1
...
{
  inline
  void swap(rnnp::FeatureVectorCompact& x, rnnp::FeatureVectorCompact& y)
  {
    x.swap(y);
  }
};
