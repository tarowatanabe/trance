...
#ifndef __RNNP__FEATURE__GRAMMAR__HPP__
#define __RNNP__FEATURE__GRAMMAR__HPP__ 1
...
namespace rnnp
{
  namespace feature
  {
    ...
    struct GrammarImpl
    {
      ...
      typedef rnnp::FeatureFunction feature_function_type;
	...
	*reinterpret_cast<symbol_type*>(state) = label;
    ...
    struct FactoryGrammar : public rnnp::FeatureFunctionFactory
    {
