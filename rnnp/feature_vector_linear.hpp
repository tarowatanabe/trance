...
#ifndef __RNNP__FEATURE_VECTOR_LINEAR__HPP__
#define __RNNP__FEATURE_VECTOR_LINEAR__HPP__ 1
...
namespace std
{
  template <typename T, typename A>
  inline
  void swap(rnnp::FeatureVectorLinear<T,A>& x, rnnp::FeatureVectorLinear<T, A>& y)
  {
    x.swap(y);
  }
};
